...
export default {
  ...
  data() {
    return {
      linkedInUrl: 'https://www.linkedin.com/in/ruiyang-zhou', // LinkedIn URL
      githubUrl: 'https://github.com/Rayz0722', // GitHub URL
      instagramUrl: 'https://www.instagram.com/rayzry22/', // Instagram URL
    };
  },
}
</script>
